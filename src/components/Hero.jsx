...
function Hero(){
    ...
    return(
       <section id="hero" className="bg-slate-900 text-white min-h-screen flex items-center">
        <div className="max-w-7xl grid md:grid-cols-2 mx-auto px-8 gap-12 items-center">
            {/* left side */}
            <motion.div initial={{
                x:-100,
                opacity:0
  ...
  <div className="grid grid-cols-2 gap-8 text-7xl">
