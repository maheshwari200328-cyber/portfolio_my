function EducationCard(props){
    return(
        <div className="bg-slate-800  m-4 md:m-8 mx-8 p-6 text-center shadow-lg leading-8  text-white rounded-xl hover:-translate-y-2 transition duration-300 border ">
